...
// Branded preview for the home page. Next wires this as the default og:image +
// twitter:image automatically (metadataBase is absolute).
export const runtime = "nodejs";
export const alt = "Bento Cards — your market, rated out of 99";
...
export default async function Image() {
  const card = SAMPLE_CARDS.find((c) => c.login === "demo-btc-100k") ?? SAMPLE_CARDS[0];
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", flex: 1, height: "100%", paddingRight: 48 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", marginTop: "auto", marginBottom: "auto" }}>
            <div style={{ display: "flex", fontSize: 108, fontWeight: 800, lineHeight: 0.95 }}>RATE</div>
            ...
            <div style={{ display: "flex", fontSize: 34, color: "#a8b3bd", marginTop: 26, maxWidth: 600, lineHeight: 1.3 }}>
              Turn any Bento.fun market into a player card, rated out of 99 — then bet.
            </div>
          </div>
          <div style={{ display: "flex", fontSize: 28, color: "#6e7681" }}>bento.fun</div>
        </div>
