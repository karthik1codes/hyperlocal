...
const RECEIPTS: { metric: string; label: string }[] = [
  { metric: METRIC_LABELS.commits, label: "Recent volume" },
  { metric: METRIC_LABELS.starsEarned, label: "Total volume" },
  { metric: METRIC_LABELS.pullRequests, label: "Traders" },
  { metric: METRIC_LABELS.followers, label: "Reach" },
  { metric: METRIC_LABELS.codeReviews, label: "Depth" },
  { metric: METRIC_LABELS.contributions, label: "Lifetime volume" },
];
