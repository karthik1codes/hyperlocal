...
import VersusMarketPanel from "./VersusMarketPanel";
  ...
  return (
    <>
      ...
      >
        ...
        <VersusMarketPanel challenger={challenger} opponent={opponent} />
      </main>
    </>
  );
}
